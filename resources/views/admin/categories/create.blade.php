        ...
        <form method="POST" action="{{ route("admin.categories.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('most_recent') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="most_recent" id="most_recent" value="1" {{ old('most_recent', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('fav') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="fav" id="fav" value="1" {{ old('fav', 0) == 1 ? 'checked' : '' }}>
