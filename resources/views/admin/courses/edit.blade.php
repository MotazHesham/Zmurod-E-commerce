    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.courses.update", [$course->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('courses_hours') ? 'is-invalid' : '' }}" type="number" name="courses_hours" id="courses_hours" value="{{ old('courses_hours', $course->courses_hours) }}" step="0.01">
