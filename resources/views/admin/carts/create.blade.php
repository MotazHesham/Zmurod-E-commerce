...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.carts.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="price">{{ trans('cruds.cart.fields.price') }}</label>
            ...
            <div class="form-group">
                <label class="required" for="total_cost">{{ trans('cruds.cart.fields.total_cost') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.cart.fields.total_cost_helper') }}</span>
            </div>
            <div class="form-group">
