        ...
        <form method="POST" action="{{ route("admin.sellers.update", [$seller->id]) }}" enctype="multipart/form-data">
            ...
            <div class="row justify-content-between">
              ...
              <div class="form-group col-3">
                  ...
                  <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $seller->user->email) }}" required>
                  @if($errors->has('email'))
                      <div class="invalid-feedback">
                          {{ $errors->first('email') }}
                      </div>
              ...
              <div class="form-group col-3">
                ...
                <input class="form-control {{ $errors->has('country') ? 'is-invalid' : '' }}" type="text" name="country" id="country" value="{{ old('country', $seller->user->country) }}">
            ...
            <div class="row justify-content-between">
              <div class="form-group col-3 mt-5">
                ...
                <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text" name="phone" id="phone" value="{{ old('phone', $seller->user->phone) }}">
                @if($errors->has('phone'))
                    <div class="invalid-feedback">
                        {{ $errors->first('phone') }}
                    </div>
            ...
            <div class="row justify-content-between">
              <div class="form-group col-3 mt-5">
                ...
                <input class="form-control {{ $errors->has('store_name') ? 'is-invalid' : '' }}" type="text" name="store_name" id="store_name" value="{{ old('store_name', $seller->store_name) }}" required>
