            ...
            <div class="row">
                <div class="col-lg-8 col-xl-9 order-lg-last col-md-12 order-md-first">
                        ...
                        <div class="single-blog-post blog-grid-post">
                            ...
                            <div class="blog-post-content-inner mt-30px" data-aos="fade-up" data-aos-delay="400">
                                <div class="blog-athor-date">
                                    <span> بواسطة,<a class="blog-author cercle-shape ml-5" href="#"> {{$blog->user->name}}</a></span>
                                    <span class="blog-date" href="#">{{$blog->created_at}}</span>
                                </div>
                    ...
                    <div class="comment-area">
                        <h2 class="comment-heading" data-aos="fade-up" data-aos-delay="200">التعليقات (03)</h2>
                                    ...
                                    <div class="review-top-wrap">
                                        <div class="review-left">
                                            <div class="review-name">
                                                <h4 class="title">مي ممحمد </h4>
                                                <span class="date">21 مايو 2023</span>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="sidebar-widget">
                            ...
                            <div class="recent-post-widget">
                                <div class="recent-single-post d-flex">
                                    <div class="thumb-side">
                                        <a href="blog-single.html"><img
                                                src="{{asset('blog-single.html')}}" alt="" /></a>
                                    </div>
                                ...
                                <div class="recent-single-post d-flex">
                                    <div class="thumb-side">
                                        <a href="blog-single.html"><img
                                                src="{{asset('assets/images/blog-image/2.jpg')}}" alt="" /></a>
                                    </div>
                                    <div class="media-side">
                                ...
                                <div class="recent-single-post d-flex">
                                    <div class="thumb-side">
                                        <a href="blog-single.html"><img
                                                src="{{asset('assets/images/blog-image/3.jpg')}}" alt="" /></a>
                                    </div>
                                    <div class="media-side">
                                        <span class="date">مايو 2023</span>
                                ...
                                <div class="recent-single-post d-flex">
                                    <div class="thumb-side">
                                        <a href="blog-single-left-sidebar.html"><img
                                                src="{{asset('assets/images/blog-image/1.jpg')}}" alt="" /></a>
                                    </div>
                                    <div class="media-side">
