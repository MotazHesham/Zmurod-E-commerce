    ...
    <div class="blog-grid pb-100px pt-100px main-blog-page single-blog-page">
        <div class="container">
            <div class="row">
                    ...
                    <div class="blog-posts">
                        <div class="single-blog-post blog-grid-post">
                            ...
                            <div class="blog-image single-blog" data-aos="fade-up" data-aos-delay="200">
                                <img class="img-fluid h-auto" src="{{$course->photo->getUrl()}}"
                                    alt="blog" />
                            </div>

                            <div class="blog-post-content-inner mt-30px" data-aos="fade-up" data-aos-delay="400">
                                <div class="blog-athor-date">
                                    <span class="m-5"> بواسطة,<a class="blog-author cercle-shape" href="#">{{$course->trainer}}</a></span>
                                    <span class="blog-date mr-4" href="#">{{$course->created_at->format('  j F    ')}}</span>
                                </div>
                ...
                <!-- Sidebar Area Start -->
                <div class="col-lg-4 col-xl-3 col-md-12 mt-md-50px mt-lm-50px" data-aos="fade-up"
                    data-aos-delay="200">
                    <div class="blog-sidebar mr-20px">
                        ...
                        <div class="sidebar-widget text-center">
                            ...
                            <div class="instructor_pricing_widget csv2">
                                <h3 class="new-price">ر.س{{$course->price}}</h3>
                            ...
                            <br />
                            <button class="btn btn-primary btn-hover-dark border-0  blog-btn btn-center mt-30px" type="submit"> اشترك الان </button>
                        </div>
                        <!-- Sidebar single item -->
