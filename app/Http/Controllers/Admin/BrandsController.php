...
class BrandsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $table->editColumn('brand_image', function ($row) {
                if ($photo = $row->brand_image) {
                    return sprintf(
            ...
            $table->rawColumns(['actions', 'placeholder', 'brand_image']);
    ...
    public function store(StoreBrandRequest $request)
    {
        ...
        if ($request->input('brand_image', false)) {
            $brand->addMedia(storage_path('tmp/uploads/' . basename($request->input('brand_image'))))->toMediaCollection('brand_image');
        }
    ...
    public function update(UpdateBrandRequest $request, Brand $brand)
    {
        ...
        if ($request->input('brand_image', false)) {
            if (! $brand->brand_image || $request->input('brand_image') !== $brand->brand_image->file_name) {
