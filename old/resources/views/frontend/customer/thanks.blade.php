            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-md-8">
                    <div class="inner_complated">
                        <div class="img_cmpted"><img src="{{asset('assets/images/logo5.png')}}" alt=""></div>
                        <p class="dsc_cmpted">شكرا للطلب  من مكانَه. سوف تتلقى رسالة تأكيد بالبريد الإلكتروني قريبا.</p>
